...
class BinLogStreamReader(object):
    ...
    def __init__(self, connection_settings, server_id, resume_stream=False,
        ...
        self.exclude_query = set(['COMMIT', 'BEGIN'])
    ...
    def fetchone(self):
        while True:
            ...
            #if binlog_event.schema not in self.__only_schemas:
            #    continue
            ...
            if isinstance(binlog_event.event, QueryEvent) and binlog_event.event.query in self.exclude_query:
                continue
